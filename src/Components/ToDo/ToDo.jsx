const ToDo = () => {
  return (
    <div className="bg-white min-h-screen-h-[570px] max-h-[571px] overflow-scroll shadow p-5 shadow-[#b8b7b7] rounded-md mr-0   large:mr-0 block ">
      ...
      <div className=" flex justify-between items-center mt-6">
        <h1 className=" flex items-center gap-3">
          <input type="checkbox" checked className="checkbox border-white checked:border-white [--chkbg:theme(colors.gray.300)] [--chkfg:white] " />
          Select All
        </h1>
      ...
      <div className=" mt-7 font-medium text=[#2E1619] text-[18px] space-y-5">
        <h1 className=" flex items-center gap-3">
          <input type="checkbox" checked="checked" className="checkbox border-white checked:border-white [--chkbg:theme(colors.rose.400)] [--chkfg:white]  " />
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. <span className=" text-[#E0E0E0]">Last Added: 10 sep 2022</span>
        </h1>
        <h1 className=" flex items-center gap-3 ">
          <input type="checkbox" checked="checked"  className="checkbox border-white checked:border-white [--chkbg:theme(colors.gray.300)] [--chkfg:white]   " />
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. <span className=" text-[#E0E0E0]">Last Added: 10 sep 2022</span>
        </h1>
        <h1 className=" flex items-center gap-3">
          <input type="checkbox" checked="checked"  className="checkbox border-white checked:border-white [--chkbg:theme(colors.gray.300)] [--chkfg:white] " />
